...
class Trainer:
    def __init__(self, total_cls):
        ...
        self.bias_layers = [self.bias_layer1, self.bias_layer2,
                            self.bias_layer3, self.bias_layer4, self.bias_layer5]
    ...
    def train(self, batch_size, epoches, lr, max_size):
        ...
        for inc_i in range(dataset.batch_num):
            ...
            bias_optimizer = optim.Adam(
                self.bias_layers[inc_i].parameters(), lr=0.001)
            exemplar.update(total_cls//dataset.batch_num,
            ...
            test_acc = []
            ckp_name = 'BIC_cifar100/checkpoint/{}_run_{}_iteration_{}_model.pth'.format(
